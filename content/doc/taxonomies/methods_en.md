...
.Pages
: All Pages assigned to this term. All [list methods](/doc/templates/list/) are available to this.
...
.Pages
: Returns a slice of pages, which then can be ordered using any of the [list methods](/doc/templates/list/).
