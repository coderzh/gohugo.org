...
menu:
  main:
    parent: taxonomy
next: /doc/taxonomies/displaying
prev: /doc/taxonomies/overview
...
you need to set the `preserveTaxonomyNames` [site configuration](/doc/overview/configuration/) variable to `true`.
