...
menu:
  main:
    parent: content
next: /doc/content/supported-formats
prev: /doc/overview/source-directory
title: Content Organization
toc: true
weight: 10
---

Hugo uses files (see [supported formats](/doc/content/supported-formats/)) with headers commonly called the *front matter*. Hugo
...
in Hugo and is used as the [section](/doc/content/sections/).
...
with the same path. Includes [section](/doc/content/sections/).

### section
`section` is determined by its location on disk and can *not* be specified in the front matter. See [section](/doc/content/sections/).

### type
`type` is also determined by its location on disk but, unlike `section`, it *can* be specified in the front matter. See [type](/doc/content/types/).
...
path. Includes [section](/doc/content/sections/).
