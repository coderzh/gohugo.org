...
menu:
  main:
    parent: extras
next: /doc/extras/scratch
prev: /doc/extras/shortcodes
title: Pagination
weight: 80
---

Hugo supports pagination for the home page, sections and taxonomies. It's built to be easy use, but with loads of flexibility when needed. The real power shines when you combine it with [`where`](/doc/templates/functions/), with its SQL-like operators, `first` and others --- you can even [order the content](/doc/templates/list/) the way you've become used to with Hugo.
