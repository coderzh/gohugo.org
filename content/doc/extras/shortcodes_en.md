...
menu:
  main:
    parent: extras
next: /doc/extras/pagination
prev: /doc/extras/permalinks
title: Shortcodes
toc: false
weight: 80
---
...
want a [partial template](/doc/templates/partials/) instead.
...
HTML. Read more on [highlighting](/doc/extras/highlighting/).
...
Read more on [cross-references]({{% ref "doc/extras/crossreferences.md" %}}).
...
You can also use the variable `.Page` to access all the normal [Page Variables](/doc/templates/variables/).
