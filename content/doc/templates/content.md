...
menu:
  doc:
    name: 内容模板
    parent: layout
next: /doc/templates/list
prev: /doc/templates/variables
...
Users can specify the `type` and `layout` in the [front-matter](/doc/content/front-matter/). `Section`
...
variables](/doc/layout/variables/) and [site
...
It makes use of [partial templates](/doc/templates/partials/)
...
[content archetypes](/doc/content/archetypes/).
