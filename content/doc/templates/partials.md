...
menu:
  doc:
    name: 复用模板
    parent: layout
next: /doc/templates/rss
prev: /doc/templates/views
...
By ensuring that we only reference [variables](/doc/layout/variables/)
...
templates](/doc/templates/content/), [list templates](/doc/templates/list/) and [homepage templates](/doc/templates/homepage/).**
