...
menu:
  main:
    parent: layout
next: /doc/templates/views
prev: /doc/templates/homepage
...
taxonomy. This is different from the [list template](/doc/templates/list/)
...
[node variables](/doc/templates/variables/) and
[site variables](/doc/templates/variables/)
...
It makes use of [partial templates](/doc/templates/partials/). The list of taxonomy
templates cannot use a [content view](/doc/templates/views/) as they don't display the content, but
