...
> I'm running into an issue where I cannot get archetypes working, when running `hugo new doc/showcase/test.md`, for example, I see an `EOF` error thrown by Hugo.
>
...
>
> When in that repository, using Hugo v0.12 to run `hugo new -v doc/showcase/test.md`, I see the following output:
>
>     INFO: 2015/01/04 Using config file: /private/tmp/test/config.toml
>     INFO: 2015/01/04 attempting to create  doc/showcase/test.md of showcase
